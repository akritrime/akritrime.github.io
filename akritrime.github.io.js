...
},{"./leaves-pattern.png":[["dbd7829845be4c3112434e62925d013e.png",9],9],"_css_loader":8}],6:[function(require,module,exports) {
...
window.addEventListener('load', function () {
    ...
    setTimeout(function () {
        var ft = document.querySelector("#footer_text");
    ...
    setTimeout(function () {
        ...
        Array.from(intro.querySelector("div").children).forEach(function (p, i) {
        ...
        Array.from(skills.querySelector("div").children).forEach(function (p, i) {
...
// }, 5000)
},{"normalize.css":10,"./index.scss":7,"./animation.css":6}],12:[function(require,module,exports) {
